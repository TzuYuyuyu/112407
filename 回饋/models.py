...
class Feadback(models.Model):
    username = models.CharField(max_length=100)
    userEmail = models.EmailField(unique=True, max_length=255, blank=False, null=False)
    userFeadback = models.CharField(max_length=300)
    userrecommend = models.CharField(max_length=300)
